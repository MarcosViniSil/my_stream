...
async def get_user_videos(offset: int = Form(...),userVideosService: UserVideosService = Depends(getUserVideosRepository),access_token: str = Cookie(...)):
...
async def insert_time_watched(videoId = Form(...),timeWatched:int = Form(...),userVideosService: UserVideosService = Depends(getUserVideosRepository),access_token: str = Cookie(...)):
...
async def insert_time_watched(videoId = Form(...),userVideosService: UserVideosService = Depends(getUserVideosRepository),access_token: str = Cookie(...)):
