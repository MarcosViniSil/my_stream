...
CREATE TABLE tb_video(
    ...
    videoSubTitles VARCHAR(255) UNIQUE,
...
--INSERT INTO tb_user (userId,userName,userRole,userEmail,userPassword) VALUES (UNHEX(REPLACE('3f06af63-a93c-11e4-9797-00505690773d', '-','')),'Marcos vinícius','ADMIN','marcossilv2044@gmail.com','12345678');
